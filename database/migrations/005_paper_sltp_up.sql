...
BEGIN;
ALTER TABLE paper_positions ADD COLUMN sl numeric;   -- stop-loss trigger (NULL = none)
ALTER TABLE paper_positions ADD COLUMN tp numeric;   -- take-profit trigger (NULL = none)
COMMIT;
